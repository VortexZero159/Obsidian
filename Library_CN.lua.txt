--This Obsidian UI Library supported for both New and Old example
...
function Library:CreateWindow(WindowInfo)
    ...
    if Library.IsMobile then
        ...
        local LockButton = Library:AddDraggableButton("启用锁定", function(self)
            Library.CantDragForced = not Library.CantDragForced
            self:SetText(Library.CantDragForced and "解除锁定" or "启用锁定")
        end, true)
